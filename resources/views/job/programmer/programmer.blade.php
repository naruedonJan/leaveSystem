...
@section('title', 'Digitalmerce || โปรแกรมเมอร์')

@section('content')

<div class="panel panel-primary">
    <div class="panel-heading"><h4>งานโปรแกรมเมอร์</h4></div>
    <div class="panel-body">
        <form action="{{ url('/job/programmer') }}" method="GET">
            @csrf
            <div class="row">
        ...
        <table class="table table-hover table-striped">
            <thead class="thead-dark">
                <tr>
                    ...
                    <th class="text-center" scope="col" width="30%">รายละเอียดงาน</th>
            ...
            <tbody>
                ...
                @endswitch
                        ...
                        <form action="{{ url('/job/programmer') }}" method="GET">
                            @csrf
                            <input type="hidden" name="del_id" value="{{ $job->pm_id }}">
